...
?>
<section id="main" data-page="loop">
    <div class="title_header grid-100 parallax" data-image-src="<?=get_theme_mod('header_image', get_template_directory_uri() . "/static/img/header.jpg")?>">
        <h1><?php _e('Latest Posts', "quiet_theme"); ?></h1>
    </div>
    <div id="content">
        <div class="max_900">
