...
<div id="main">
    <div class="title_header grid-100 parallax" data-image-src="<?=esc_url($header_image)?>">
        <h1><?php printf( __( 'Author Archives: <span class="vcard">%s</span>', 'quiet_theme' ), $authordata->display_name ) ?></h1>
            ...
            <?php if ( !empty($authordesc) ){?>
                <div class="page_content_container">
                    <div class="regular_padding">
                        <?= apply_filters( 'archive_meta', '<p class="archive-meta">' . $authordesc . '</p>' ); ?>
                    </div>
                </div>
            <?php } rewind_posts(); ?>
