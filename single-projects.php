...
<section id="main" data-page="single">
    ...
    <div class="title_header grid-100 parallax" data-image-src="<?=esc_url($background_image)?>">
        ...
        <?php edit_post_link( __( 'Edit Project', 'quiet_theme' ), '<div class="more-button-wrap"><div class="white_edit_post edit_link_wrap no_margin margin_on_top">', '</div></div>' ) ?>
    </div>
        ...
        <div class="max_900">
            <div class="page_post_wrap">
                <div id="post-<?= esc_html($post_id)?>" <?php post_class('post'); ?>>
                    ...
                    <div class="single_cat_menu">
                        <p>
                            <a href="<?=get_site_url()?>/projects"><?php _e("View all projects", "quiet_theme")?></a>
                        </p>
                    </div>

                    <div id="nav-below" class="navigation">
    					<div class="prev"><?php previous_post_link( '%link', '<span class="meta-nav">&laquo;</span> %title' ) ?></div>
